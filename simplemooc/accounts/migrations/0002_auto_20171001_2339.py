    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createad_at', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('confirmed', models.BooleanField(default=False, verbose_name='Confiramdo ?')),
            ],
            options={
                'verbose_name': 'Nova Senha ',
                'verbose_name_plural': 'Novas Senhas',
                'ordering': ['-createad_at'],
            },
        ),
